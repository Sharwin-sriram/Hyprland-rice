...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 2.5, bezier = "slide", style = "slide 100%" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 2.5, bezier = "slide", style = "slide 100%" })
